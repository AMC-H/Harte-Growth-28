    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e9e1d1;border-radius:14px;overflow:hidden;max-width:100%;">
        <tr><td style="padding:32px 32px 20px;">
          ...
          <h1 style="color:#17140f;font-size:24px;line-height:1.25;margin:8px 0 4px;font-weight:800;letter-spacing:-.02em;">Nieuw groeigesprek gepland</h1>
          <p style="color:#6b6a63;font-size:14px;margin:0 0 22px;">Iemand heeft een moment gekozen via de landing.</p>

          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f6f1e7;border:1px solid #e9e1d1;border-left:3px solid #ff4d1a;border-radius:10px;padding:20px 22px;color:#17140f;font-size:15px;line-height:1.6;margin-bottom:22px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f6f1e7;border:1px solid #e9e1d1;border-radius:10px;padding:20px 22px;color:#17140f;font-size:15px;line-height:1.6;">
            ...
            <tr><td style="padding:6px 0;color:#6b6a63;">Bereikbaar</td><td style="padding:6px 0;">${escape(contact)}</td></tr>
            <tr><td style="padding:6px 0;color:#6b6a63;">Aangevraagd op</td><td style="padding:6px 0;font-size:13px;color:#6b6a63;">${new Date().toLocaleString('nl-NL', { timeZone: 'Europe/Amsterdam' })}</td></tr>
          </table>

          <div style="margin-top:22px;padding:14px 18px;background:#fff6f0;border-left:3px solid #ff4d1a;border-radius:8px;color:#6b6a63;font-size:13.5px;line-height:1.55;">
